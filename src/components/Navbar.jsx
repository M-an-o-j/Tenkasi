      ...
      <section id=''>
        <div className='md:p-5 w-full md:bg-primary'>
          <img
            src={menu ? close : open}
            alt=""
            className='fixed top-4 left-4 z-50 md:hidden w-8 bg-secondary p-[5px] rounded-full' 
            onClick={() => setMenu(!menu)}
            />
          <ul className={`p-20 md:p-0 h-screen md:h-auto md:flex fixed md:left-5 z-30 md:top-0 flex-col md:bg-primary bg-secondary  md:flex-row ${menu ? "left-0" : "-left-96"} duration-500 rounded-tr-2xlm rounded-br-2xl ease-in-out `}>
